...
$(function () {
	...
	//最后一波才使用技能
	 var autoUseSkillLast = store("autoUseSkillLast");
    if(autoUseSkillLast=="true"){
        autoUseSkillLast = true;
    }else{
        autoUseSkillLast = false;
    }
    $("#autoUseSkillLast").prop("checked",autoUseSkillLast);
    $("#autoUseSkillLast").change(function(e){
        store("autoUseSkillLast",$(this).prop("checked"));
    });
