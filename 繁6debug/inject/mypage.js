$(function(){
	...
	setTimeout(function(){
		...
		var weaponSkillMap = {
			"屬性角色的攻擊力上升(小)":["assault", 0, 0.5],
			"屬性角色的攻擊力上升(中)":["assault", 3, 0.5],
			"屬性角色的攻擊力上升(大)":["assault", 6, 0.5],
			"屬性角色的攻擊力上升(特大)":["assault", 10, 1],
			"屬性角色的HP上限上升(小)":["defender", 0, 0.5],
			"屬性角色的HP上限上升(中)":["defender", 3, 0.5],
			"屬性角色的HP上限上升(大)":["defender", 6, 0.5],
			"屬性角色的HP上限上升(特大)":["defender", 10, 1],
			"屬性攻擊力上升":["ambition", 10, 1],
			"屬性角色所剩的HP愈少攻擊威力愈大(小)":["pride", 0, 0.35, 11.4],	//小：0.35×SLv+12*(1-HP/MHP)	浮动0%~11.4%
			"屬性角色所剩的HP愈少攻擊威力愈大(中)":["pride", 0, 0.5, 11.4],		//中：0.5×SLv+12*(1-HP/MHP)		浮动0%~11.4%
			"屬性角色所剩的HP愈少攻擊威力愈大(大)":["pride", 0, 0.5, 19],		//大：0.5×SLv+20*(1-HP/MHP)		浮动0%~19%
			"屬性角色的二段攻擊機率上升(小)":["rush", 0, 0],
			"屬性角色的二段攻擊機率上升(中)":["rush", 1, 0],
			"屬性角色的二段攻擊機率上升(大)":["rush", 2, 0],
			"屬性角色的三段攻擊機率上升(小)":["barrage", 0, 0],
			"屬性角色的三段攻擊機率上升(中)":["barrage", 1, 0],
			"屬性角色的三段攻擊機率上升(大)":["barrage", 2, 0],
			"屬性角色的弱點攻擊機率上升(小)":["stinger", 0, 0.5],
			"屬性角色的弱點攻擊機率上升(中)":["stinger", 3, 0.5],
			"屬性角色的弱點攻擊機率上升(大)":["stinger", 6, 0.5],
			"屬性角色的爆裂攻擊上升(小)":["exceed", 0, 1, 10],
			"屬性角色的爆裂攻擊上升(中)":["exceed", 10, 1, 25],
			"屬性角色的爆裂攻擊上升(大)":["exceed", 20, 1, 40],
			"屬性角色的回復力上升(小)":["ascension", 4, 1, 3],
			"屬性角色的回復力上升(中)":["ascension", 7, 1, 4],
			"屬性角色的回復力上升(大)":["ascension", 10, 1, 5],
			"属性キャラクターのアビリティ性能UP(小)":["elaborate", 10, 1, 2],
			"属性キャラクターのアビリティ性能UP(中)":["elaborate", 10, 1, 3.5],
			"属性キャラクターのアビリティ性能UP(大)":["elaborate", 10, 1, 5],
			//属性キャラクターの残存HP割合が
			"屬性角色的HP比率愈多攻擊力上升(小)":["vigorous", 8, 0.2],
			"屬性角色的HP比率愈多攻擊力上升(中)":["vigorous", 12, 0.2],
			"屬性角色的HP比率愈多攻擊力上升(大)":["vigorous", 16, 0.2],
			"屬性角色的連續攻擊機率上升(小)":["ballanche", 0, 0],
			"屬性角色的連續攻擊機率上升(中)":["ballanche", 1, 0],
			"屬性角色的連續攻擊機率上升(大)":["ballanche", 2, 0],
			"屬性角色的攻撃力和三段攻撃確率上升(小)":["triedge", 0, 0.5],
			"屬性角色的攻撃力和三段攻撃確率上升(中)":["triedge", 3, 0.5],
			"屬性角色的攻撃力和三段攻撃確率上升(大)":["triedge", 6, 0.5],
			"屬性角色的HP和攻撃力上升(小)":["strength", 0, 0.5],
			"屬性角色的HP和攻撃力上升(中)":["strength", 3, 0.5],
			"屬性角色的HP和攻撃力上升(大)":["strength", 6, 0.5],
			"属性角色的攻撃力上升(特大)":["carnage", 10, 1],
			"屬性角色的HP和回復力上升(小)":["grace", 0, 0.5, 4, 1],
			"屬性角色的HP和回復力上升(中)":["grace", 3, 0.5, 7, 1],
			"屬性角色的HP和回復力上升(大)":["grace", 6, 0.5, 10, 1],
			"装備中的「剣」的攻撃·HP性能上升":["bladeEnhance", 0, 0],	//武器类型强化：30%攻击，45%生命　「剣」を6個以上装備で効果発動
			"装備中的「特殊剣」的攻撃·HP性能上升":["ripperEnhance", 0, 0],
			"装備中的「槍」的攻撃·HP性能上升":["sarissaEnhance", 0, 0],
			"装備中的「錘」的攻撃·HP性能上升":["malletEnhance", 0, 0],
			"装備中的「杖」的攻撃·HP性能上升":["staffEnhance", 0, 0]
		};
		...
		function createEnhanceRCupBtn() {
			var enhanceRCupBtn = $("<button type='button' class='btn'>强R杯</button>");
				...
				_http.get({
					...
					if(data&&data.length>0){
						_.each(data,function(item,i){
							//过滤R圣杯
							if(item.weapon_id==6000&&item.rare=="R"&&item.level==1&&item.exp==0&&!item.is_equipped&&!item.is_locked){
		...
		function createEnhanceSRWeaponBtn() {
			var enhanceSRWeaponBtn = $("<button type='button' class='btn'>强SR</button>");
			...
			enhanceSRWeaponBtn.click(function(){
				...
				_http.get({
					...
					if(data&&data.length>0){
						_.each(data,function(item,i){
							//过滤SR武器（SR圣杯基础攻击150）
							if(item.rare=="SR"&&item.level==1&&item.exp==0&&item.attack>160&&!item.is_equipped&&!item.is_locked){
		...
		function createEnhanceSRCupBtn() {
			var enhanceSRCupBtn = $("<button type='button' class='btn'>强SR杯</button>");
			...
			enhanceSRCupBtn.click(function(){
				...
				_http.get({
					...
					if(data&&data.length>0){
						_.each(data,function(item,i){
							//过滤SR圣杯
							if(item.weapon_id==5000&&item.rare=="SR"&&item.level==1&&item.exp==0&&!item.is_equipped&&!item.is_locked){
		...
		function createEnhanceRWeaponBtn() {
			var enhanceRWeaponBtn = $("<button type='button' class='btn'>强R</button>");
		...
		function showInfo() {
			...
			mypageLog("特殊模块暂时整合");
			mypageLog("装备强化模块回溯");
			mypageLog("商店兑换暂时关闭一键土豆大星星");
			mypageLog("Bug日志：");
			mypageLog("未终突火系武器技能（中）有些微bug，攻刃略微浮动");
			mypageLog("幻武除枪、斧之外暂时无法计算");
			mypageLog("战斗模式若有特殊需求请自行导入");
		};
