$(function(){
	...
	function wld(){
		...
		if(settings.autoUseSkillLast&&!isAutoLast){
			if(_wld.stage._currentStage==_wld.stage._maxStage){
				setTimeout(function () {
					_wld.battleUI.AutoButton._onTouchEvent(_wld.battleUI.AutoButton._widget, 2);
				}, 1000);
			isAutoLast = true;
			// debugger;
			}
