...
if(window.location.toString().indexOf("http://pc-play.games.dmm.co.jp/play/kamipro_X_Gro")>-1){
...
}else if(window.location.toString().indexOf(".skh.dmmgames.com")>-1 && window.location.toString().indexOf("/tyrano.html")==-1){
